...
function show_logo() {
    ...
    curl -s https://raw.githubusercontent.com/Sshadow84/sepolia-auto-install/main/other/logo.sh | bash
}
...
# === Проверяем и добавляем ключ VERSION в ~/.env-sepolia-version ===
  ...
  REMOTE_VC_URL="https://raw.githubusercontent.com/Sshadow84/sepolia-auto-install/main/other/version_control.json"
...
function run_rpc_check {
  URL="https://raw.githubusercontent.com/Sshadow84/sepolia-auto-install/main/other/rpc_check.sh"
